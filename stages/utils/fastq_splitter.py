...
parser.add_argument('-s', '--split',type=int, help='how many splits to interleve in the input\t[4]')
parser.add_argument('-j', '--jump',type=str, help='which split index to jump to\t[4]')
